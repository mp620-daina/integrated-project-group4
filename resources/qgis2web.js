...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        maxZoom: 11,
        minZoom: 6,
        extent: [481270.413028, 9247234.232475, 502737.189274, 9259102.645549],
        projection: new ol.proj.Projection({
            code: 'EPSG:32737',
            //extent: [484968.414517, 9248787.038037, 494329.344360, 9257483.534184],
            units: 'm'
        })
    })
});
...
map.getView().fit([481270.413028, 9247234.232475, 502737.189274, 9259102.645549], map.getSize());
